...
let currentUsers: string [] = ["Admin","Earic","Nadeem", "Rashid","Farah"];
let newUsers: string [] = ["Admin","Nadeem","Fatima","Ali","Salman"];
 
let  currentUsers_lower : string [] = currentUsers.map(user =>  user.toLowerCase())
for(let newUser of newUsers ){
    if(currentUsers_lower.includes(newUser.toLowerCase())){
        console.log(`sorry ${newUser},that name is taken`);
        
    }else{
        console.log(`yes ${newUser}, is still in avaiable list`);
